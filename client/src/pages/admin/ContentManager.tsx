...
import { Plus, Edit, Trash2, FileText, CheckCircle, XCircle, List } from 'lucide-react';
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <PageHeader
                ...
                description="Manage blog posts, news, and categories."
                action={
                    activeTab === 'posts' && (
            ...
            {/* Top Level Tabs: Posts vs Categories */}
            <div className="flex space-x-1 p-1 bg-slate-900/50 rounded-lg w-fit border border-white/5">
                <Button
                    variant={activeTab === 'posts' ? 'default' : 'ghost'}
                    size="sm"
                    onClick={() => setActiveTab('posts')}
                    className={activeTab === 'posts' ? 'bg-accent text-white shadow-neon-sm' : 'text-slate-400'}
                >
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="hover:bg-transparent border-white/5">
                                    <TableHead className="w-[40%] text-slate-200">Title</TableHead>
                                ...
                                {isLoading ? (
                                    ...
                                    filteredItems?.map((post: BlogPostDto) => (
                                        <TableRow key={post.id}>
                                            ...
                                            <TableCell className="text-slate-400 font-medium">{post.category || 'Uncategorized'}</TableCell>
                                            <TableCell>
